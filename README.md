  ...
  <body onload="startTime()">
    ...
    <div class="main">
      <div class="content">
        ...
        <div class="tanggal">
          <p class="tgl">Tuesday , 12 December</p>
        </div>
        <div class="notif notif1 kelip" onclick="balas()">
          ...
          <div class="nama nama1">
            <p>dhanny si memerang❤</p>
          </div>
          <div class="isi">
            <p>Hey i already know ur name but can u write it back for me baby girl ? 🥺</p>
          </div>
        </div>
        ...
        <div class="btn-mulai">
          <p class="hilang1" onclick="notif1()">can u press it for me</p>
          <p class="hilang2">click chat kat atas tu</p>
          <p class="kirimWA">send chat kat Whatsapp</p>
        </div>
      </div>
    </div>
    <a href="https://wa.me/6281298829876" class="copyright">
      <p class="cr"><i class="material-icons-sharp cr-logo"> copyright </i></p>
      <p>Dhanny Si Memerang.ID</p>
    </a>
